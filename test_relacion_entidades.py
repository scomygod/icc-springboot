...
try:
    ...
    #  o condgiruadno un entorno e intslado lel paquete 
    print(  "o instálelo en su entorno virtual.")
    print("     python3 -m venv env")
    print("     source env/bin/activate  # En Linux/Mac")
    print("     .\\env\\Scripts\\activate  # En Windows")
    print("     python3 -m pip install requests")
